...
function showlarge_animation(title, image){
	var app_string
	app_string = "..\\..\\images\\content\\landuse\\" + image
	document.location.href = app_string
} 

//popup a larger image
function showlarge_animation1(title, image){
	var app_string
	app_string = "images\\content\\landuse\\" + image
	document.location.href = app_string
} 
...
function showlarge(title, image, year, scenario ){
	var app_string
	app_string = "..\\..\\Data\\Current Scenarios\\" + scenario +"\\"+ year +"\\" + image
	document.location.href = app_string
...
function hotspotselection(title, image, year){
	var app_string
	app_string += "..\\..\\..\\..\\Data\\Indicators\\meta_indicator_" + image
	document.location.href = app_string
}
